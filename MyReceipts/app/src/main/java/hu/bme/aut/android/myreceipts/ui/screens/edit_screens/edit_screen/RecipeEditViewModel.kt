package hu.bme.aut.android.myreceipts.ui.screens.edit_screens.edit_screen
...
import hu.bme.aut.android.myreceipts.ui.model.asEditingRecipeUI
        ...
        viewModelScope.launch{
            try {
                ...
                if(validRecipe(recipe)) {
                    ...
                    recipeOperations.updateRecipe(_state.value.recipe.asRecipe())
        ...
        viewModelScope.launch {
            try {
                recipeOperations.loadRecipe(id).getOrThrow().collectLatest{
                    _state.value = RecipeEditState(it.asEditingRecipeUI())
                }
            }
            catch (e: Exception){
                _uiEvent.send(RecipeEditScreenUIEvent.Failure(e.message ?: "Unknown error"))
